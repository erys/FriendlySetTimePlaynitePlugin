...
{
    public class FriendlySetTimeSettings : ObservableObject
    {
    ...
    public class FriendlySetTimeSettingsViewModel : ObservableObject, ISettings
    {
        ...
        public FriendlySetTimeSettings Settings
        {
            get => settings;
            set
            {
        ...
        public FriendlySetTimeSettingsViewModel(FriendlySetPlugin plugin)
        {
            ...
            // Load saved settings.
            var savedSettings = plugin.LoadPluginSettings<FriendlySetTimeSettings>();
            ...
            {
                Settings = new FriendlySetTimeSettings();
            }
        }
